...
namespace Aventi\LowStockNotification\Helper;
...
/**
 * Class Data
 * @package Aventi\LowStockNotification\Helper
 */
class Data extends AbstractHelper
{
    ...
    const LOW_STOCK_SINGLE_ALERT_TEMPLATE_FILE =
                    'Aventi_LowStockNotification::notifications/low_stock_single_alert.phtml';

    const LOW_STOCK_ALERT_TEMPLATE_FILE = 'Aventi_LowStockNotification::notifications/low_stock_alert.phtml';
